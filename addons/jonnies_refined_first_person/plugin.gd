...
func _enable_plugin() -> void:
	...
	create_dialog_box("Jonnie's Refined First Person: Input actions mapped to Project Settings! Press OK to restart editor.")
...
func _disable_plugin() -> void:
	...
	create_dialog_box("Jonnie's Refined First Person: Input actions removed from Project Settings. Restart editor manually or remove an input action for change to take effect.")
